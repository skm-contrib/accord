 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    if (document.querySelector("[data-catalog-header]")) document.addEventListener("click", (function(e) {
        if (!e.target.closest(".catalog-header") && !e.target.closest("[data-catalog-header]") && document.documentElement.classList.contains("catalog-header-open")) document.documentElement.classList.remove("catalog-header-open");
        if (e.target.closest("[data-catalog-header]")) document.documentElement.classList.toggle("catalog-header-open");
    }));
    if (document.querySelector("[data-filter-button]")) document.addEventListener("click", (function(e) {
